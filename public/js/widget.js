(function(){
  ...
  // It is intentionally never rendered into the DOM, logged to the console,
  // or written anywhere persistent -- it only ever lives in this variable
  // and in the Authorization-equivalent header of outgoing fetch() calls.
  ...
  function leadPanelHtml(){
    ...
    return '<div class="wg-panel"><h4>Leave your contact details</h4>' +
      ...
      '<input id="wgLeadPhone" placeholder="Phone (optional)" />' +
